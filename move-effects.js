...
overlay.style.cssText = `position:fixed;inset:0;background:rgba(0,0,0,.75);z-index:1100; display:flex;align-items:center;justify-content:center;flex-direction:column;gap:16px;`;
...
btn.style.cssText = `background:var(--surface2);border:1px solid var(--border2);color:var(--text); font-family:var(--font);font-size:8px;padding:8px 12px;cursor:pointer;border-radius:4px; display:flex;align-items:center;gap:6px;`;
...
cancelBtn.style.cssText = `background:none;border:1px solid var(--border2);color:var(--muted); font-family:var(--font);font-size:8px;padding:6px 14px;cursor:pointer;border-radius:4px;margin-top:4px;`;
...
overlay.style.cssText = `position:fixed;inset:0;background:rgba(0,0,0,.8);z-index:1100; display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;`;
...
el.style.cssText = `width:70px;height:98px;border:1px solid var(--border2);border-radius:4px; overflow:hidden;cursor:grab;position:relative;background:var(--surface2);`;
el.innerHTML = `<img src="${c.images?.small||''}" alt="${c.name}" style="width:100%;height:100%;object-fit:cover;"> <div style="position:absolute;bottom:0;left:0;right:0;background:rgba(0,0,0,.7); font-family:var(--font);font-size:5px;color:#fff;text-align:center;padding:2px;">${c.name}</div> <div style="position:absolute;top:2px;left:2px;background:rgba(0,0,0,.7); font-family:var(--font);font-size:6px;color:var(--accent);padding:1px 3px;border-radius:2px;">#${pos+1}</div>`;
...
confirmBtn.style.cssText = `background:var(--accent);color:#000;border:none;font-family:var(--font); font-size:9px;padding:10px 24px;cursor:pointer;border-radius:4px;`;
...
const overlay = document.createElement(‘div’);
overlay.style.cssText = `position:fixed;inset:0;background:rgba(0,0,0,.75);z-index:1100; display:flex;align-items:center;justify-content:center;flex-direction:column;gap:16px;`;
overlay.innerHTML = `<div style="font-family:var(--font);font-size:10px;color:var(--accent)">Prophecy — Choose Deck</div> <div style="display:flex;gap:12px;"> <button onclick="this.closest('div[style]').remove();window._prophecyChoice=${player}" style="font-family:var(--font);font-size:9px;padding:10px 18px;background:var(--surface2);border:1px solid var(--p1color);color:var(--p1color);cursor:pointer;border-radius:4px;">Your Deck (P${player})</button> <button onclick="this.closest('div[style]').remove();window._prophecyChoice=${opp}" style="font-family:var(--font);font-size:9px;padding:10px 18px;background:var(--surface2);border:1px solid var(--p2color);color:var(--p2color);cursor:pointer;border-radius:4px;">Opponent's Deck (P${opp})</button> </div>`;
document.body.appendChild(overlay);
